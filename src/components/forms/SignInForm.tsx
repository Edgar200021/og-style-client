						...
						<div className="mt-10">
							<div>
								<form onSubmit={onSubmit} >
									<fieldset disabled={isLoading} className='b-0 p-0 m-0 space-y-6'>
										<div>
										...
										<div className="">
											<div className="text-sm leading-6">
												<Link to="/auth/forgot-password" className="font-semibold text-dark  hover:text-indigo-500">
													Забыли пароль?
												</Link>
											</div>
										</div>
							...
							<div className="mt-10">
								...
								<div className="absolute inset-0 flex items-center" aria-hidden="true">
									...
									<div className="relative flex justify-center text-sm font-medium leading-6">
										<span className="bg-white px-6 text-gray-900">Или войдите с помощью</span>
									</div>
								</div>
