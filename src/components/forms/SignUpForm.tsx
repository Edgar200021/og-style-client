								...
								<fieldset disabled={isLoading} className='b-0 p-0 m-0 space-y-6'>
									...
									<div className="">
										<div className="text-sm leading-6">
											<Link to="/auth/sign-in" className="font-semibold text-dark  hover:text-indigo-500">
												Уже есть аккаунт?
											</Link>
										</div>
									</div>
							...
							<div className="mt-10">
								<div className="relative">
									...
									<div className="relative flex justify-center text-sm font-medium leading-6">
										<span className="bg-white px-6 text-gray-900">Или региструйтесь с помощью</span>
									</div>
								</div>
