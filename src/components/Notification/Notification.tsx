...
export const Notification = ({
  ...
  return (
    <article className={cn('text-center max-w-[480px]', className)}>
      ...
      <div className="flex justify-center">
        <img
          className="w-[142px] h-[108px] object-contain mb-[50px] md:mb-[38px] md:w-[114px] md:h-[87px] "
          src={
            variant === 'success'
      ...
      <span className="block uppercase max-xsm:text-xl text-2xl font-medium tracking-[0.01em] mb-2 md:font-semibold md:mb-3">
        {title}
      </span>
      <p className="text-dark mb-24 max-xsm:text-sm sm:mb-6">{text}</p>
      <Button
        className="font-medium py-3 tracking-[0.01em] md:font-semibold"
        onClick={closeFn}
      >
        Закрыть
      </Button>
