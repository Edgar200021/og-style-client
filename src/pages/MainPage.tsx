  ...
  return (
    <main className={cn('', className)}>
      <div className="container ">
        ...
        <ul className="flex flex-col gap-y-3 min-[490px]:gap-5  min-[490px]:grid min-[490px]:grid-cols-2 min-[800px]:grid-cols-4 min-[800px]:grid-rows-[repeat(5,110px)] lg:grid-rows-[repeat(5,160px)]">
          {SELL.map((sell, i) => (
            <li className={cn({
				...
				'min-[800px]:col-start-3 min-[800px]:row-span-3 min-[800px]:col-span-full': i === 3
			})} key={sell.title}>
              <Sell className='min-[490px]:h-full' {...sell} category={sell.category as Product['category']} />
            </li>
          ))}
          <li className="px-4 py-6 bg-yellow-100 rounded-xl md:px-6 md:py-[28px] lg:px-8 lg:py-[78px] col-span-2 min-[800px]:row-span-2  ">
